...
type UpdateCommunicationResponse = {
  success: boolean;
  message?: string;
  communication?: {
    id: string;
...
export default function EditCommunicationForm({
  ...
  async function handleSubmit(
    ...
    try {
      ...
      const result =
        (await response.json()) as UpdateCommunicationResponse;
      ...
      console.error(
        "SoccaR communication draft update error:",
        error
      );

      setErrorMessage(
        "Something unexpected happened while updating this draft."
      );
    } finally {
      setSaving(false);
    }
    ...
    >
      ...
      >
        ...
        <span>
          ...
          >
            Marks this draft as the featured Founder Update when it is eventually published.
          </span>
        </span>
      </label>
