...
export default function Communities() {
  ...
  return (
    <section
      ...
      style={{
        paddingTop:
          "clamp(116px, 9vw, 158px)",
        paddingBottom:
          "clamp(128px, 10vw, 182px)",
      }}
    >
      <div
        className="w-full"
              ...
              reduceMotion
                ...
                : {
                    ...
                    color:
                      "#9CE500",
                    boxShadow:
                      "0 14px 36px rgba(156,229,0,0.09)",
                  }
            }
            transition={{
              duration: 0.3,
